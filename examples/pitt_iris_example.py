...
"""
pitt_iris_example4.py: A simple example to illustrate how a Pittsburgh rule
                       system works.  Genomes are all fixed length, and
                       standard (i.e.  fixed length) reproductive operators
                       are used.
